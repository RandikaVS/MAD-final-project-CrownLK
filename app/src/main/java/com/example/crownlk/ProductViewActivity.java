...
import static com.example.crownlk.R.drawable.*;
...
public class ProductViewActivity extends AppCompatActivity {
    ...
    private Button buy, cart,fav,msg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(ProductViewActivity.this, SingInActivity.class);
    ...
    private void addFav() {
        progressDialog.setMessage("Adding item to Wishlist....");
        progressDialog.show();
        final String timestamp = String.valueOf(System.currentTimeMillis());
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("id", timestamp);
        ...
        databaseReference.child(timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        progressDialog.dismiss();
                        fav.setBackgroundResource(ic_redfav);
                        Toast.makeText(ProductViewActivity.this, "Add to Wishlist Successfully ...", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
